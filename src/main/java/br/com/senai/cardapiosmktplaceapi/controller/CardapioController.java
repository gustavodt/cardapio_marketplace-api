...
public class CardapioController {
	...
	public ResponseEntity<?> buscarPor(
			@PathVariable("id")
			Integer id) {
		Cardapio cardapioEncontrado = cardapioService.buscarPor(id);
	...
	public ResponseEntity<?> listarPor(
		...
		Page<Cardapio> page = cardapioService.listarPor(restaurante, paginacao);
	...
	public ResponseEntity<?> inserir(
		...
		Cardapio cardapioSalvo = cardapioService.inserir(novoCardapio);
	...
	public ResponseEntity<?> alterar(
		...
		Cardapio cardapioAtualizado = cardapioService.alterar(cardapioSalvo);
	...
	public ResponseEntity<?> atualizarStatusPor(
			...
			@PathVariable("status")
			Status status) {
			this.cardapioService.atualizarStatusPor(id, status);
